...
int main(void)
{
  int pins_array[6] = { GPIO_Pin_8, GPIO_Pin_8 | GPIO_Pin_9, GPIO_Pin_9, 
	GPIO_Pin_9 | GPIO_Pin_10, GPIO_Pin_10, GPIO_Pin_10 | GPIO_Pin_8 };
  ...
  while (1)
  {
    if (dir)
    {
	pin_color = pins_array[COLOR_COUNT - k - 1];
    }
    else
    {
	pin_color = pins_array[k];
    }
